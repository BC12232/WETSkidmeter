...
if (PLCConnected){
	plc_client.readHoldingRegister(100,5,function(resp){
		...
		var timeString = String(time_Century +"-" +correct_time_Month +"-" +correct_time_Date +"T" +correct_time_Hour +":" +correct_time_Minutes +":" +correct_time_Seconds +"+03:00");
